...
<body>
        ...
        <!-- Main include -->
 	    ...
 	    <!-- Content Wrapper. Contains page content -->
            ...
            <!-- Main content -->
            <section class="content container-fluid" style="width:100%;height:100%">
            	<img alt="" style="width:100%;height:100%" src="${base }/imgage/404.jpg"/>
            	<img alt="" onclick="javascript:history.go(-1);"
            		style="position: absolute;top: 65%;left:47.5%;width: 5%;margin: 0 auto;" 
            		src="${base }/imgage/return.png">
            </section>
            <!-- /.content -->
